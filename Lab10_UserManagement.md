...
1. 各ユーザーでのログイン
    ...
    | user2 | エディター|指定された名前空間で変更権限を持ちます。特定のの名前空間（今回はlab-spaceのみ）、許可されたカタログにアクセス可能です。チームのユーザー編集はできませんが、各種オブジェクトの変更が可能です。モニタリングやアラートにはアクセスできません。  |
    | user3 | オペレーター |指定された名前空間で変更権限を持ちます。特定のの名前空間（今回はlab-spaceのみ）、許可されたカタログにアクセス可能です。チームのユーザー編集はできませんが、各種オブジェクトの変更は可能です。モニタリングやアラートにアクセスできます。 |
